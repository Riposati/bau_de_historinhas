 ...
 * @author Gustavo
 */
public class TelaVerTodasHistorias extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Baú de historinhas - Visualizar todas histórias");
        setResizable(false);
        ...
        jLabel1.setText("Todas as históras do baú de historinhas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerTodasHistorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaVerTodasHistorias().setVisible(true);
            }
        });
    }
