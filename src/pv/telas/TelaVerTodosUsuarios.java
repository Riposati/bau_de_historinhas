 ...
 * @author Gustavo
 */
public class TelaVerTodosUsuarios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Baú de historinhas - Visualizar  todos usuários");
        setResizable(false);
        ...
        jLabel1.setText("Todos os usuarios do baú de historinhas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaVerTodosUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TelaVerTodosUsuarios().setVisible(true);
            }
        });
    }
